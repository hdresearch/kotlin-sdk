...
data class WhoamiApiKey(
    ...
    @SerialName("label")
    val label: String,
    @SerialName("max_memory_mib")
    val max_memory_mib: Long? = null,
    @SerialName("max_vcpus")
    val max_vcpus: Int? = null,
)
...
data class CommitInfo(
    ...
    val grandparent_commit_id: String? = null,
    @SerialName("is_public")
    val is_public: Boolean,
    @SerialName("name")
    val name: String,
...
data class DeploySettings(
    ...
    val build_command: String? = null,
    @SerialName("install_command")
    val install_command: String? = null,
    @SerialName("run_command")
    val run_command: String? = null,
...
data class VmCreateVmConfig(
    ...
    val kernel_name: String? = null,
    @SerialName("labels")
    val labels: Map<String, String>? = null,
    /** The RAM size, in MiB. */
    @SerialName("mem_size_mib")
    val mem_size_mib: Int? = null,
    /** How many vCPUs to allocate to this VM (and its children) */
    @SerialName("vcpu_count")
    val vcpu_count: Int? = null,
)
